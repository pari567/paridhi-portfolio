...
export default function Contact() {
  return (
    <section id="contact" style={{ backgroundColor: '#f0ebe0', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="px-8 md:px-14 lg:px-20" style={{ position: 'relative', zIndex: 1 }}>
        ...
        {/* Two-column body */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16" style={{ marginTop: '60px', paddingBottom: '80px' }}>
