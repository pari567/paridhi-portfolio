...
export default function Contact() {
  return (
    <section id="contact" style={{ backgroundColor: '#f0ebe0' }}>

      {/* Bounded header — ghost contained here */}
      <div className="px-8 md:px-14 lg:px-20">
        <div style={{ position: 'relative', overflow: 'hidden', paddingTop: '140px', paddingBottom: '24px' }}>
          <div style={{
            position: 'absolute',
            top: '60px',
            left: '60px',
      ...
      {/* Two-column body — starts below ghost area */}
      <div
